...
ayushi_image = face_recognition.load_image_file("Ayushi/Ayushi.jpg")
ayushi_face_encoding = face_recognition.face_encodings(ayushi_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    bradley_face_encoding,
    ayushi_face_encoding
]
known_face_names = [
    "Bradley Cooper",
    "Ayushi Shukla"
